...
import io.mp.claudecodepanel.health.HealthCheck
import io.mp.claudecodepanel.health.HealthGatherer
import io.mp.claudecodepanel.health.HealthReport
import io.mp.claudecodepanel.health.HealthSanitizer
import io.mp.claudecodepanel.health.HealthStatus
    ...
    private fun recheck() {
        ...
        ApplicationManager.getApplication().executeOnPooledThread {
            ...
            ApplicationManager.getApplication().invokeLater({
                if (isShowing) result?.let { render(io.mp.claudecodepanel.health.HealthChecker.evaluate(it)) } ?: renderError()
            }, ModalityState.any())
        }
    }
