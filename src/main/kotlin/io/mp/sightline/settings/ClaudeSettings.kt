...
@State(name = "SightlineSettings", storages = [Storage("sightline.xml")])
class ClaudeSettings : SimplePersistentStateComponent<ClaudeSettings.State>(State()) {
    ...
    class State : BaseState() {
        ...
        /**
         * Whether the one-time first-run disclosure has been acknowledged. Deliberately never reset on
         * upgrade: a notice people have dismissed and then see again teaches them to dismiss it faster.
         */
        var firstRunAcknowledged by property(false)
