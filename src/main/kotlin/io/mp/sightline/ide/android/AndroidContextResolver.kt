...
import io.mp.sightline.android.GradleModuleInfo
import io.mp.sightline.android.GradleModuleParser
import io.mp.sightline.android.ModuleContext
import io.mp.sightline.android.OutputMetadata
import io.mp.sightline.android.OutputMetadataParser
import io.mp.sightline.android.VariantName
import io.mp.sightline.android.VersionCatalogParser
import java.io.File
...
class AndroidContextResolver(private val project: Project) {
    ...
    /**
     * Project-relative paths of the Kotlin/Java sources, for [io.mp.sightline.android.TestSelection].
     *
