...
import io.mp.sightline.android.CrashInvestigator
import io.mp.sightline.android.DeviceAction
import io.mp.sightline.android.DeviceActions
import io.mp.sightline.android.DeviceRecipe
import io.mp.sightline.android.DeviceRecipes
import io.mp.sightline.android.LogLevel
import io.mp.sightline.android.LogcatParser
import io.mp.sightline.android.LogcatRedactor
...
class AndroidDeviceTools(private val project: Project) {
    ...
    private fun investigateCrash(args: JsonObject): String {
        ...
        val signal = LogcatParser.signals(entries)
            .lastOrNull { it.kind == io.mp.sightline.android.LogSignal.Kind.CRASH ||
                it.kind == io.mp.sightline.android.LogSignal.Kind.ANR }
            ?: return json {
