...
import io.mp.sightline.activity.ActivityColorRole
import io.mp.sightline.activity.ActivityColorRoles
import io.mp.sightline.activity.ActivityGraph
import io.mp.sightline.activity.ClusterCollapser
import io.mp.sightline.activity.LabelPlacement
import io.mp.sightline.activity.MapDensity
...
import io.mp.sightline.ui.state.TimelineDockState
...
class ActivityMapPanel(private val project: Project, parent: Disposable) : Disposable {
    ...
    private fun openSettings() {
        com.intellij.openapi.options.ShowSettingsUtil.getInstance()
            .showSettingsDialog(project, io.mp.sightline.settings.ClaudeSettingsConfigurable::class.java)
    }
